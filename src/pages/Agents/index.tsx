...
import { AlertCircle, Bot, Check, Plus, RefreshCw, Settings2, Trash2, X, Brain, Tag, Briefcase, FileText } from 'lucide-react';
    ...
    >
      ...
      <div className="flex flex-col flex-1 min-w-0 py-0.5 mt-1">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-1">
          <p className="text-xs text-muted-foreground leading-[1.5] flex items-center gap-1">
